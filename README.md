...
> **手太慢，抢不到悟空AI邀请码？**
>
> 钉钉悟空AI每个整点放出限量邀请码，几秒就被抢光。手动刷网页、复制粘贴、点提交——等你操作完，码早没了。
>
> 这个工具帮你全自动完成：**刷新网页 → OCR 识别邀请码 → 填入悟空AI App → 点击提交**，全程不到 2 秒。让手慢的玩家也能体验悟空AI！

## 工作原理

```
┌─────────────┐    OCR     ┌─────────────┐  AppleScript/  ┌─────────────┐
│  悟空AI官网    │ ────────→  │  识别邀请码  │ ──PowerShell─→ │  悟空AI App    │
...
1. 已安装 [悟空AI App](https://www.dingtalk.com/wukong) 并打开到邀请码输入页面
2. 悟空AI App 已登录钉钉账号
